...
<body>
    ...
    <div class="wrapper wrapper-content">
        <div class="row">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <a class="btn btn-default btn-sm" data-toggle="modal" data-target="#modaleliminaproveedor" href="#">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group"><label>Nombre del proveedor</label> <input type="text" placeholder="" class="form-control"></div>
            ...
            <div class="modal inmodal fade" id="modaleliminaproveedor" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
                            <h4 class="modal-title">Elimina proveedor</h4>
                            <small class="font-bold"></small>
                        </div>
                        <div class="modal-body">
                            <p><strong>¿Esta seguro de eliminar el proveedor?</strong> Al borrar al proveedor se borrará toda la información relacionada con este.</p>
                            <div class="form-group"><label>Selecciona al proveedor</label> 
