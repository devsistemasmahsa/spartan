                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped " data-page-size="8" data-filter="#filter">
                                ...
                                <tr>
                                    ...
                                    <th data-hide="phone" style="background-color: #2e64fe; color: white">Factura</th>
                                    <th data-hide="phone" style="background-color: #2e64fe; color: white">Fecha factura</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr class="gradeX">
