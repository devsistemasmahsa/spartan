                            ...
                            <table class="footable table table-stripped" data-filter=#filter>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Descripción</th>
                                        <th>Horas</th>
                                        <th style="width: 100px;"><a href="modmanodeobra.php?l=<?php echo base64_encode($num_listado) ?>" class="btn btn-success  btn-block"><i class="fa fa-plus-square-o"></i> Modificar mano de obra</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 100px;"><a href="modrefacciones.php?l=<?php echo base64_encode($num_listado) ?>" class="btn btn-success btn-block " ><i class="fa fa-plus-square-o"></i> Modificar refacciones</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                   <?php //IMPRIMIMOS TODOS LOS USUARIOS
