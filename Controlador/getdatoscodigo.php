...
?>
<form role="form" action="../controlador/agregareflistadotec.php" method="POST">
 ...
 <div class="row">
  ...
  <div class="col-12">
    ...
    <input type="text" readonly="true" class="form-control"  value="<?php echo $descr ?>" name="descripcioncodigo">
  </div>
  <div class="col-6">
